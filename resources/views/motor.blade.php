<x-app-layout>
    ...
    <div class="container mx-auto flex flex-col items-center">
        <h1 class="text-lg font-semibold text-center mb-6">Customize Motorcycles</h1>
        
        <div class="mb-6">
            <button onclick="window.location.href='{{ route('motor.create') }}'" class="upload-button">
                {{ __('Upload') }}
            </button>
        </div>
                ...
                <div class="card">
                    <a href="{{ route('motor.see', $item->id) }}" class="block">
                        <div class="flex justify-center mb-2 p-4">
                            <img src="{{ asset($item->image) }}" alt="Motorcycle Image" />
                        </div>
